...
inline void ConstructImFont(ImFont *_this) { imgui_function_table_instance()->ConstructImFont(_this); }
inline void DestructImFont(ImFont *_this) { imgui_function_table_instance()->DestructImFont(_this); }
inline bool ImFont::IsGlyphInFont(ImWchar c) const { return imgui_function_table_instance()->ImFont_IsGlyphInFont(const_cast<ImFont *>(this), c); }
